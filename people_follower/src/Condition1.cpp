...
// Condition 1 distance - accleration - angle (0.8-1.5-0)
 // modified to 0.3 - 0.5 - 0
...
double MaxSpeed=1.5; // 0.5 Maximum speed the robot can drive. the speed is m/s (formerly 0.8) 
double KpDistance = 0.8; //0.5 Ratio between the speed of the robot and the distance to the robot current target. (speed = kp*distance)
                        // higher Kp means faster accleration, and more aggresive movements (formerly 1)
double KpAngle=0.5; // same as KpDistance, only for the angular velocity.

//parameters should be changed according to experiment/human goal
double followingAngle = 0/PI; //the angle the robot should follow the human, in Radians
double DistanceTarget=0.3;      //the distance the robot should keep to human, in Meters
...
//	 n.param(std::string("max_speed"), MaxSpeed, 1.2);
    ...
    //sc.playWaveFromPkg("sound_play","/home/robot/workspace/ros/catkin/Shalomandnaming.wav");
    //sc.playWaveFromPkg("sound_play","/home/laptoplx/Downloads/Shalomandnaming.wav");
    ...
    //const char *str1= "/home/robot/workspace/ros/catkin/Shalomandnaming.wav";
    //sc.startWave(str1);
    //sleepok(8, nh);
    //sc.stopWave(str1);
    ...
    //sound_play::Sound s1 = sc.voiceSound("This is another form");
    //s1.play();
    //sleepok(10, nh);
    //s1.stop();
