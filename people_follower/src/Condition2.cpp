...
// Condition 1 (1.2-0.8-30)
 // Condition 1 distance - accleration - angle (0.8-1.2-30)
 // modified to 0.3 - 0.5 - 30
...
double MaxSpeed=0.5; // Maximum speed the robot can drive. the speed is m/s (formerly 0.8) 
double KpDistance = 0.5; // Ratio between the speed of the robot and the distance to the robot current target. (speed = kp*distance)
